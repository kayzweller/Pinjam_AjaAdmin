...
public class SubmenuDetailPeminjamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_submenu_detail_peminjam);

        // calling extra
        Bundle extras = this.getIntent().getExtras();
        if (extras != null) {
            mIDPeminjam = extras.getString(SubmenuDetailActivity.SEND_ID_PEMINJAM);
        }
