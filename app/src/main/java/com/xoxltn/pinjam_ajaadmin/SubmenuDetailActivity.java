...
public class SubmenuDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_submenu_detail);
    ...
    public void onClickDataPeminjam(View view) {
        Intent dataPeminjam = new Intent(this, SubmenuDetailPeminjamActivity.class);
        dataPeminjam.putExtra(SEND_ID_PEMINJAM, mIDPeminjam);
        startActivity(dataPeminjam);
    }

    public void onClickDataPendana(View view) {
        Intent dataPendana = new Intent(this, SubmenuDetailPendanaActivity.class);
