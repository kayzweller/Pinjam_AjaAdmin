...
public class SubmenuDetailPendanaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_submenu_detail_pendana);

        // calling extra
        Bundle extras = this.getIntent().getExtras();
        if (extras != null) {
            mIDPendana = extras.getString(SubmenuDetailActivity.SEND_ID_PENDANA);
        }
