...
public class ReturnAdapter extends FirestoreRecyclerAdapter<Return, ReturnAdapter.ReturnHolder>{

    private OnItemClickListener listener;

    public ReturnAdapter(@NonNull FirestoreRecyclerOptions<Return> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ReturnHolder holder, int position,
                                    @NonNull Return model) {
