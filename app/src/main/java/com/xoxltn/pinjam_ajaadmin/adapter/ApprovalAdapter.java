package com.xoxltn.pinjam_ajaadmin.adapter;
...
public class ApprovalAdapter extends FirestoreRecyclerAdapter<Approval,
        ApprovalAdapter.ApprovalHolder> {

    private OnItemClickListener listener;

    public ApprovalAdapter(@NonNull FirestoreRecyclerOptions<Approval> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ApprovalHolder holder, int position,
                                    @NonNull Approval model) {
