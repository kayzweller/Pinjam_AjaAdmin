...
public class SubmenuApprovalPeminjamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_submenu_approval_peminjam);

        // calling extra
        Bundle extras = this.getIntent().getExtras();
        if (extras != null) {
            mIDPeminjam = extras.getString(SubmenuApprovalActivity.SEND_ID_PEMINJAM);
        }
    ...
    private void callDataPeminjam(final String IDPeminjam) {
        ...
        fireStorage.getDownloadUrl().addOnSuccessListener(uri -> Picasso.get().load(uri)
                .fit().centerCrop().into(imageview_ktp));
