...
public class RequestPeminjamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_peminjam);

        // calling extra
        Bundle extras = this.getIntent().getExtras();
        if (extras != null) {
            mIDPeminjam = extras.getString(RequestActivity.SEND_ID_PEMINJAM);
        }
    ...
    public void onClickPerbaikiData (View view) {
        ...
        docRef2.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(RequestPeminjamActivity.this,
                        "Permintaan Pinjaman dibatalkan!", Toast.LENGTH_SHORT).show();

                startActivity(new Intent(RequestPeminjamActivity.this,
