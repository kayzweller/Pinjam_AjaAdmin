...
import com.xoxltn.pinjam_ajaadmin.DashboardActivity;
import com.xoxltn.pinjam_ajaadmin.R;

import java.util.Objects;

public class ApprovalPendanaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approval_pendana);

        // calling extra
        Bundle extras = this.getIntent().getExtras();
        if (extras != null) {
            mIDPendana = extras.getString(ApprovalActivity.SEND_ID_PENDANA);
        }
    ...
    public void onClickPerbaikiData (View view) {
        docRef.update("id_pendana", null);
        docRef.update("pendanaan_status", false);
        docRef.update("pendanaan_req", true);
        docRef.update("pinjaman_status", "MENUNGGU PENDANAAN");
        ...
        docRef.update("info_rekening", "un-done")
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(ApprovalPendanaActivity.this,
                        "Request pendanaan dibatalkan!", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(ApprovalPendanaActivity.this,
