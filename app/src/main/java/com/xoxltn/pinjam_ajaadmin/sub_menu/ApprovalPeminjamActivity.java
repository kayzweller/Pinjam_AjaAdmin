...
public class ApprovalPeminjamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approval_peminjam);

        // calling extra
        Bundle extras = this.getIntent().getExtras();
        if (extras != null) {
            mIDPeminjam = extras.getString(ApprovalActivity.SEND_ID_PEMINJAM);
        }
